        ...
        {likedVideosList.map(likedVideo => 
            <div className="video-card card-w-25 mg-l-1 csr-point txt-s pd-b-05 mg-tb-05 flex-col flex-col-space-evenly">
                ...
                <div className="flex flex-space-evenly">
                    ...
                    <button onClick={() => removeLikeHandler(likedVideo.videoId, likedVideosList)} className="pd-05 mg-05 bdr-thick bdr-yellow bdr-rad-m btn btn-secondary-yellow w-100">Remove Like</button>
                </div>
            </div>
        )}     
